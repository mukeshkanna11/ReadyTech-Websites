    ...
    <footer className="relative overflow-hidden text-gray-200 bg-gray-900">
      ...
      <div className="relative z-10 grid gap-12 px-6 py-16 mx-auto max-w-7xl sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm">
            <strong>📞 Phone:</strong>{" "}
            <a href="tel:+917010797721" className="underline transition hover:text-indigo-400">+91 70107 97721</a><br/>
            <strong>📧 Email:</strong>{" "}
            <a href="mailto:info@readytechsolutions.in" className="underline transition hover:text-indigo-400">info@readytechsolutions.in</a>
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="space-y-2">
            <li>
              <Link to="/about" className="transition hover:text-indigo-400">About</Link>
            </li>
            <li>
              <Link to="/services" className="transition hover:text-indigo-400">Services</Link>
            </li>
            <li>
              <Link to="/development" className="transition hover:text-indigo-400">Development</Link>
            </li>
            <li>
              <Link to="/contact" className="transition hover:text-indigo-400">Contact</Link>
            </li>
          </ul>
        </div>
