...
import { FaLaptopCode, FaPhoneAlt, FaBullseye, FaEnvelope, FaMapMarkerAlt, FaGlobe } from "react-icons/fa";
      ...
      <section className="relative flex flex-col items-center justify-center h-[500px] overflow-hidden text-white text-center px-6">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <div className="flex justify-center gap-4 mb-6 text-center text-white">
            ...
            <div><p className="text-3xl font-bold">{countdown.minutes}</p><p>Minutes</p></div>
      ...
      <section className="grid max-w-6xl gap-12 px-6 py-20 mx-auto sm:grid-cols-1 md:grid-cols-2">
        ...
        <div className="p-6 bg-gray-800 shadow-2xl rounded-xl md:p-8">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading} className="w-full py-3 font-medium text-white rounded-md bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-600 hover:shadow-xl">{loading ? "Sending..." : "Send Message"}</button>
          </form>
        </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {locations.map((loc, idx) => (
              <div key={idx} className="p-6 transition transform bg-gray-700 shadow-xl rounded-xl hover:shadow-2xl hover:-translate-y-2 hover:scale-105">
                <div className="flex justify-center mb-4 text-3xl text-indigo-400"><FaMapMarkerAlt /></div>
